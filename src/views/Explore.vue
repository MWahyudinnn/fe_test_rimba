<template>
    <div>
        <Nav class="z-20" />
        <section>
            <div class="h-sreen w-full bg-cover" style="background: url(bgrv.jpg)">
                <div class="bg-blue-800 w-full bg-opacity-50">
                    <div class="mx-auto flex h-screen w-full justify-center items-center">
                        <div class="font-montserrat w-full text-white mx-5 z-10">
                            <h1 class="font-pacifico hidden sm:block text-6xl mb-10">Search</h1>
                            <form @submit="getRecipes">
                                <input type="text" name="search" v-model="search" placeholder="Search Product" class="p-10 focus:outline-none w-4/5 sm:w-3/5 text-black">
